...
>
    <div class="container-base pt-24 xl:pt-28 3xl:pt-32 pb-16 md:pb-25 lg:pb-32 3xl:pb-50">
        <div>
            <h1 class="lg:max-w-4/5 xl:max-w-300 3xl:max-w-348 font-semibold text-2xl/8 lg:text-[48px]/14 xl:text-[55px]/15 2xl:text-[56px]/16.5 3xl:text-[70px]/20">
                {{ $settings['hero']['title'] }}
            </h1>
            <p class="text_2 lg:max-w-4/5 xl:max-w-260 3xl:max-w-315 text-brand-gray-dark mt-2 3xl:mt-5">
                {{ $settings['hero']['description'] }}
            </p>
        </div>

        <div class="flex-base flex-col md:flex-row items-center sm:items-start md:items-center gap-6 3xl:gap-10 mt-12 3xl:mt-25">
            ...
            <a href="#" class="flex-center sm:flex-base gap-3 xl:gap-4 group text-brand-gray-dark hover:text-brand-blue smooth" @click.prevent="videoModalOpen = true">
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-12.5 xl:size-15">
        ...
        <div class="max-w-278 mx-auto grid sm:grid-cols-3 gap-20 sm:gap-10 3xl:gap-40 text-center mt-16 3xl:mt-45">
            @foreach ($settings['hero']['stats'] as $stat)
                <div class="space-y-2.5">
                    <h3 class="text-3xl/7.5 xl:text-[36px]/10 3xl:text-[50px]/15">{!! strip_tags($stat['value'], '<sup><sub><br>') !!}</h3>
