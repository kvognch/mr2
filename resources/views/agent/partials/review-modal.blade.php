...
<div
    x-data="reviewModalForm({
        ...
        initialSuccessMessage: @js(session('contractor_review_success')),
        initialErrorMessage: @js($contractorReviewErrors->first()),
        shouldOpen: @js((bool) $shouldOpenContractorReviewModal),
    })"
    x-init="init()"
